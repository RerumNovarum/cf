...
public class TaskTopological {

    public static void main(String[] args) throws IOException {
        In in = new In(new FileInputStream("topsort.in"));
        PrintWriter writer = new PrintWriter(new FileOutputStream("topsort.out"));
        // --
        int n = in.nextInt();
        int m = in.nextInt();
